...
async def main():
    proxy_list = [
        ...
        # {'server': 'http://212.192.199.170:63280', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
        # {'server': 'http://46.150.251.222:63826', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
        # {'server': 'http://195.208.91.83:62158', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
        # {'server': 'http://154.223.200.11:63054', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
        # {'server': 'http://212.193.171.40:63628', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
        # {'server': 'http://195.209.145.252:63134', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
        # {'server': 'http://195.208.95.33:63172', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
        # {'server': 'http://176.103.86.191:64110', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
        # {'server': 'http://84.54.28.82:63784', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
        # {'server': 'http://84.54.31.36:63034', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
        # {'server': 'http://91.188.230.180:64558', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
        # {'server': 'http://154.209.209.241:62710', 'username': 'JKThSkEu', 'password': 'whh3hUFn'},
